package edu.buffalo.cse562.examples;
...
public class Persons1 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Persons with name Patrick Moore: "+personsByName.get("Paul Moore"));
		System.out.println("Name of persons living in Galway: "+personsByTown.get("Athlone"));
